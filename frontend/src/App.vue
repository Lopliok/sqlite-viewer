  ...
  setup() {
    ...
    async function loadTables() {
      try {
        ...
        alert('Failed to load tables: ' + error.response?.data?.error || error.message)
      }
    }
    ...
    async function selectTable(tableName) {
      ...
      try {
        ...
        alert('Failed to load table data: ' + error.response?.data?.error || error.message)
      }
    }
    ...
    async function handleDataChange(changes) {
      try {
        ...
        alert('Failed to update data: ' + error.response?.data?.error || error.message)
      }
    }
